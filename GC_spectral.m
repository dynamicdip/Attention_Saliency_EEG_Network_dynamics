function [f,causality,coherence,power] = GC_spectral(X,fs,fRes);
...
%plot-example:   plot(f,causality(:,1,2),'b-',f,causality(:,2,1),'g--'); causality
%-------------------------------------------------------------------------------------------------
%            Ref : M. Dhamala, et al. (2006).
%-------------------------------------------------------------------------------------------------
...
%Written by M. Dhamala, Univ. of Florida, Gainesville, Aug 2006.
%-------------------------------------------------------------------------------------------------
...
%Written by M. Dhamala, UF (June 2006).
...
S = 2*S(:,:,1:fix(end/2)+1)/fs/(N+npad);%factor-2 to get one-sided